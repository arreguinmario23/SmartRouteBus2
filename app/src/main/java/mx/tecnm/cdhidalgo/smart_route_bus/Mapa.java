...
public class Mapa extends AppCompatActivity implements GoogleMap.OnMyLocationButtonClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar=findViewById(id.toolbar2);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id== R.id.actualizar){
            ...
            startActivity(new Intent(Mapa.this,Login.class));
            finish();
        }
